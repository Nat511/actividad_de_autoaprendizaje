...
# Opción para descargar el archivo CSV con los datos después de la imputación simple
...
# Opción para descargar el archivo CSV con los datos después de la imputación MICE
